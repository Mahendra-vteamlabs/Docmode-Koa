...
class OrganizationsApiTestCase(utils.OrganizationsTestCaseBase):
    ...
    def test_get_organization(self):
        ...
        self.assertEqual(
            organization["description"], self.test_organization["description"]
        )
    ...
    def test_add_organization_course(self):
        ...
        with self.assertNumQueries(2):
            api.add_organization_course(self.test_organization, self.test_course_key)
    ...
    def test_remove_organization_course_missing_course(self):
        """ Unit Test: test_remove_organization_course_missing_organization """
        api.add_organization_course(self.test_organization, "edX/DemoX/Demo_Course")
