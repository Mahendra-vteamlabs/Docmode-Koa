...
from common.djangoapps.organizations.admin import (
    OrganizationAdmin,
    OrganizationCourseAdmin,
)
from common.djangoapps.organizations.models import Organization, OrganizationCourse
...
class OrganizationsAdminTestCase(utils.OrganizationsTestCaseBase):
    ...
    def setUp(self):
        ...
        self.request._messages = FallbackStorage(
            self.request
...
class OrganizationCourseAdminTestCase(utils.OrganizationsTestCaseBase):
    ...
    def test_foreign_key_field_active_choices(self):
        ...
        self.assertEqual(
            list(
                self.org_course_admin.get_form(self.request)
