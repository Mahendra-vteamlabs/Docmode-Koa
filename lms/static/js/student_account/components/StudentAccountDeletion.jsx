...
export class StudentAccountDeletion extends React.Component {
  ...
  render() {
    ...
    const loseAccessText = StringUtils.interpolate(
      ...
      {
        htmlStart: '<a href="https://docmode.zendesk.com/hc/en-us/articles/360018259172-How-do-I-link-or-unlink-my-DocMode-account-to-a-social-media-account-" target="_blank">',
        htmlEnd: '</a>',
      },
    );
