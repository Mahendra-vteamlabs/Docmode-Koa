...
from bulk_email.models import COURSE_EMAIL_MESSAGE_BODY_TAG
from .models import CustomEmailTemplate
...
class CustomEmailTemplateForm(forms.ModelForm):
    ...
    def clean_name(self):
        ...
        # if we are creating a new CustomEmailTemplate, then we need to
