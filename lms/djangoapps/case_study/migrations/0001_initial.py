            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                b"Observational (non-experimental) studies",
                                (
                                    (b"chrt-stds", b"Cohort studies"),
                                    (b"case-cntrl", b"Case control studies"),
                                    (b"rdbs", b"Routine-data-based studies"),
                                    (b"drs", b"Dose-response studies"),
                                ),
                            ),
                            (
                                b"Intervention (experimental) studies",
                                (
                                    (b"cl", b"Clinical trials"),
                                    (b"fli", b"Field trials(individual level)"),
                                    (b"fla", b"Field trials(aggregated level)"),
                                ),
                            ),
                        ],
                        db_index=True,
